...
SELECT SUM(reviews) AS review_total FROM analytics;

-- 14. Find all the categories that have more than 300 apps in them. --
SELECT category FROM analytics GROUP BY category HAVING COUNT(*) > 300;

-- 15. Find the app that has the highest proportion of min_installs to reviews, 
-- among apps that have been installed at least 100,000 times. Display the name of 
-- the app along with the number of reviews, the min_installs, and the proportion.
